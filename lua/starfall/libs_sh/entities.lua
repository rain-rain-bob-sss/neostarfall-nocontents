...
local ENT_META, NB_META, NPC_META, PHYS_META, PLY_META, VEH_META, WEP_META =
	FindMetaTable("Entity"),
	FindMetaTable("NextBot"),
	FindMetaTable("NPC"),
	FindMetaTable("PhysObj"),
	FindMetaTable("Player"),
	FindMetaTable("Vehicle"),
	FindMetaTable("Weapon")
local Ent_ManipulateBoneAngles, Ent_ManipulateBoneJiggle, Ent_ManipulateBonePosition, Ent_ManipulateBoneScale =
	ENT_META.ManipulateBoneAngles,
	ENT_META.ManipulateBoneJiggle,
	ENT_META.ManipulateBonePosition,
	ENT_META.ManipulateBoneScale

registerprivilege(
	"entities.setParent",
	"Parent",
	"Allows the user to parent an entity to another entity",
	{ entities = {} }
)
registerprivilege(
	"entities.setRenderProperty",
	"RenderProperty",
	"Allows the user to change the rendering of an entity",
	{ client = (CLIENT and {} or nil), entities = {} }
)
registerprivilege(
	"entities.setPlayerRenderProperty",
	"PlayerRenderProperty",
	"Allows the user to change the rendering of themselves",
	{}
)
registerprivilege(
	"entities.setPersistent",
	"SetPersistent",
	"Allows the user to change entity's persistent state",
	{ entities = {} }
)
registerprivilege(
	"entities.emitSound",
	"Emitsound",
	"Allows the user to play sounds on entities",
	{ client = (CLIENT and {} or nil), entities = {} }
)
registerprivilege("entities.setHealth", "SetHealth", "Allows the user to change an entity's health", { entities = {} })
registerprivilege(
	"entities.setMaxHealth",
	"SetMaxHealth",
	"Allows the user to change an entity's max health",
	{ entities = {} }
)
registerprivilege(
	"entities.doNotDuplicate",
	"DoNotDuplicate",
	"Allows the user to set whether an entity will be saved on dupes or map saves",
	{ entities = {} }
)
...
if SERVER then
	manipulateBoneBurst = SF.BurstObject(
		"manipulateBone",
		"manipulateBone",
		60,
		20,
		"Rate bones can be manipulated per second.",
		"Amount of manipulations that can happen in a short time"
	)
end

getmetatable(manipulations).__index = function(t, k)
	local r = { Position = {}, Scale = {}, Angle = {}, Jiggle = {} }
	t[k] = r
	return r
end
...
return function(instance)
	...
	local Ent_BoundingRadius, Ent_DrawModel, Ent_EmitSound, Ent_EntIndex, Ent_EyeAngles, Ent_EyePos, Ent_FindBodygroupByName, Ent_GetAngles, Ent_GetAttachment, Ent_GetAttachments, Ent_GetBodygroup, Ent_GetBodygroupCount, Ent_GetBodygroupName, Ent_GetBodyGroups, Ent_GetBoneCount, Ent_GetBoneMatrix, Ent_GetBoneName, Ent_GetBoneParent, Ent_GetBonePosition, Ent_GetBrushPlane, Ent_GetBrushPlaneCount, Ent_GetBrushSurfaces, Ent_GetChildren, Ent_GetClass, Ent_GetCollisionBounds, Ent_GetCollisionGroup, Ent_GetColor, Ent_GetColor4Part, Ent_GetCreationTime, Ent_GetDTAngle, Ent_GetDTBool, Ent_GetDTEntity, Ent_GetDTFloat, Ent_GetDTInt, Ent_GetDTString, Ent_GetDTVector, Ent_GetElasticity, Ent_GetFlexBounds, Ent_GetFlexIDByName, Ent_GetFlexName, Ent_GetFlexNum, Ent_GetFlexScale, Ent_GetFlexWeight, Ent_GetForward, Ent_GetHitBoxBone, Ent_GetHitBoxBounds, Ent_GetHitBoxCount, Ent_GetHitBoxHitGroup, Ent_GetHitboxSet, Ent_GetHitboxSetCount, Ent_GetInternalVariable, Ent_GetLocalAngles, Ent_GetLocalPos, Ent_GetManipulateBoneAngles, Ent_GetManipulateBoneJiggle, Ent_GetManipulateBonePosition, Ent_GetManipulateBoneScale, Ent_GetMaterial, Ent_GetMaterials, Ent_GetMaxHealth, Ent_GetModel, Ent_GetModelBounds, Ent_GetModelContents, Ent_GetModelRadius, Ent_GetModelRenderBounds, Ent_GetModelScale, Ent_GetMoveType, Ent_GetNoDraw, Ent_GetNumPoseParameters, Ent_GetNWEntity, Ent_GetNWVarTable, Ent_GetOwner, Ent_GetParent, Ent_GetParentAttachment, Ent_GetPersistent, Ent_GetPhysicsObject, Ent_GetPhysicsObjectCount, Ent_GetPhysicsObjectNum, Ent_GetPos, Ent_GetPoseParameter, Ent_GetPoseParameterName, Ent_GetPoseParameterRange, Ent_GetRenderFX, Ent_GetRenderGroup, Ent_GetRenderMode, Ent_GetRight, Ent_GetRotatedAABB, Ent_GetSaveTable, Ent_GetSequence, Ent_GetSequenceCount, Ent_GetSequenceInfo, Ent_GetSequenceList, Ent_GetSequenceName, Ent_GetSkin, Ent_GetSolid, Ent_GetSolidFlags, Ent_GetSubMaterial, Ent_GetTable, Ent_GetUp, Ent_GetVelocity, Ent_GetWorldTransformMatrix, Ent_HasFlexManipulatior, Ent_Health, Ent_IsDormant, Ent_IsEffectActive, Ent_IsOnFire, Ent_IsOnGround, Ent_IsSequenceFinished, Ent_IsSolid, Ent_IsValid, Ent_IsWorld, Ent_LocalToWorld, Ent_LocalToWorldAngles, Ent_LookupAttachment, Ent_LookupBone, Ent_LookupPoseParameter, Ent_LookupSequence, Ent_MapCreationID, Ent_NearestPoint, Ent_OBBCenter, Ent_OBBMaxs, Ent_OBBMins, Ent_SequenceDuration, Ent_SetBodygroup, Ent_SetBoneMatrix, Ent_SetColor, Ent_SetColor4Part, Ent_SetFlexScale, Ent_SetFlexWeight, Ent_SetHealth, Ent_SetLOD, Ent_SetMaterial, Ent_SetMaxHealth, Ent_SetNoDraw, Ent_SetPersistent, Ent_SetPoseParameter, Ent_SetRenderBounds, Ent_SetRenderFX, Ent_SetRenderMode, Ent_SetSkin, Ent_SetSubMaterial, Ent_SetupBones, Ent_SkinCount, Ent_StopSound, Ent_TranslateBoneToPhysBone, Ent_TranslatePhysBoneToBone, Ent_WaterLevel, Ent_WorldSpaceAABB, Ent_WorldToLocal, Ent_WorldToLocalAngles =
		...
		ENT_META.EyeAngles,
		ENT_META.EyePos,
		ENT_META.FindBodygroupByName,
		ENT_META.GetAngles,
		ENT_META.GetAttachment,
		ENT_META.GetAttachments,
		ENT_META.GetBodygroup,
		ENT_META.GetBodygroupCount,
		ENT_META.GetBodygroupName,
		ENT_META.GetBodyGroups,
		ENT_META.GetBoneCount,
		ENT_META.GetBoneMatrix,
		ENT_META.GetBoneName,
		ENT_META.GetBoneParent,
		ENT_META.GetBonePosition,
		ENT_META.GetBrushPlane,
		ENT_META.GetBrushPlaneCount,
		ENT_META.GetBrushSurfaces,
		ENT_META.GetChildren,
		ENT_META.GetClass,
		ENT_META.GetCollisionBounds,
		ENT_META.GetCollisionGroup,
		ENT_META.GetColor,
		ENT_META.GetColor4Part,
		ENT_META.GetCreationTime,
		ENT_META.GetDTAngle,
		ENT_META.GetDTBool,
		...
		ENT_META.GetFlexNum,
		ENT_META.GetFlexScale,
		ENT_META.GetFlexWeight,
		ENT_META.GetForward,
		ENT_META.GetHitBoxBone,
		ENT_META.GetHitBoxBounds,
		ENT_META.GetHitBoxCount,
		ENT_META.GetHitBoxHitGroup,
		ENT_META.GetHitboxSet,
		ENT_META.GetHitboxSetCount,
		ENT_META.GetInternalVariable,
		ENT_META.GetLocalAngles,
		ENT_META.GetLocalPos,
		ENT_META.GetManipulateBoneAngles,
		ENT_META.GetManipulateBoneJiggle,
		ENT_META.GetManipulateBonePosition,
		ENT_META.GetManipulateBoneScale,
		ENT_META.GetMaterial,
		ENT_META.GetMaterials,
		ENT_META.GetMaxHealth,
		ENT_META.GetModel,
		ENT_META.GetModelBounds,
		ENT_META.GetModelContents,
		ENT_META.GetModelRadius,
		ENT_META.GetModelRenderBounds,
		ENT_META.GetModelScale,
		ENT_META.GetMoveType,
		ENT_META.GetNoDraw,
		ENT_META.GetNumPoseParameters,
		ENT_META.GetNWEntity,
		ENT_META.GetNWVarTable,
		ENT_META.GetOwner,
		ENT_META.GetParent,
		ENT_META.GetParentAttachment,
		ENT_META.GetPersistent,
		ENT_META.GetPhysicsObject,
		ENT_META.GetPhysicsObjectCount,
		ENT_META.GetPhysicsObjectNum,
		ENT_META.GetPos,
		ENT_META.GetPoseParameter,
		ENT_META.GetPoseParameterName,
		ENT_META.GetPoseParameterRange,
		ENT_META.GetRenderFX,
		ENT_META.GetRenderGroup,
		ENT_META.GetRenderMode,
		ENT_META.GetRight,
		ENT_META.GetRotatedAABB,
		ENT_META.GetSaveTable,
		ENT_META.GetSequence,
		ENT_META.GetSequenceCount,
		ENT_META.GetSequenceInfo,
		ENT_META.GetSequenceList,
		ENT_META.GetSequenceName,
		ENT_META.GetSkin,
		ENT_META.GetSolid,
		ENT_META.GetSolidFlags,
		ENT_META.GetSubMaterial,
		ENT_META.GetTable,
		ENT_META.GetUp,
		ENT_META.GetVelocity,
		ENT_META.GetWorldTransformMatrix,
		ENT_META.HasFlexManipulatior,
		ENT_META.Health,
		ENT_META.IsDormant,
		ENT_META.IsEffectActive,
		ENT_META.IsOnFire,
		ENT_META.IsOnGround,
		ENT_META.IsSequenceFinished,
		ENT_META.IsSolid,
		ENT_META.IsValid,
		ENT_META.IsWorld,
		ENT_META.LocalToWorld,
		ENT_META.LocalToWorldAngles,
		ENT_META.LookupAttachment,
		ENT_META.LookupBone,
		ENT_META.LookupPoseParameter,
		ENT_META.LookupSequence,
		ENT_META.MapCreationID,
		ENT_META.NearestPoint,
		ENT_META.OBBCenter,
		ENT_META.OBBMaxs,
		ENT_META.OBBMins,
		ENT_META.SequenceDuration,
		ENT_META.SetBodygroup,
		ENT_META.SetBoneMatrix,
		ENT_META.SetColor,
		ENT_META.SetColor4Part,
		ENT_META.SetFlexScale,
		ENT_META.SetFlexWeight,
		ENT_META.SetHealth,
		ENT_META.SetLOD,
		ENT_META.SetMaterial,
		ENT_META.SetMaxHealth,
		ENT_META.SetNoDraw,
		ENT_META.SetPersistent,
		ENT_META.SetPoseParameter,
		ENT_META.SetRenderBounds,
		ENT_META.SetRenderFX,
		ENT_META.SetRenderMode,
		ENT_META.SetSkin,
		ENT_META.SetSubMaterial,
		ENT_META.SetupBones,
		ENT_META.SkinCount,
		ENT_META.StopSound,
		ENT_META.TranslateBoneToPhysBone,
		ENT_META.TranslatePhysBoneToBone,
		ENT_META.WaterLevel,
		ENT_META.WorldSpaceAABB,
		ENT_META.WorldToLocal,
		ENT_META.WorldToLocalAngles
	local function Ent_IsNextBot(ent)
		return dgetmeta(ent) == NB_META
	end
	...
	local Phys_GetAngleVelocity, Phys_GetInertia, Phys_GetMass, Phys_GetMassCenter, Phys_IsValid, Phys_LocalToWorldVector, Phys_WorldToLocalVector =
		PHYS_META.GetAngleVelocity,
		PHYS_META.GetInertia,
		PHYS_META.GetMass,
		PHYS_META.GetMassCenter,
		PHYS_META.IsValid,
		PHYS_META.LocalToWorldVector,
		PHYS_META.WorldToLocalVector

	local owrap, ounwrap = instance.WrapObject, instance.UnwrapObject
	local ents_methods, ent_meta, ewrap, eunwrap =
		instance.Types.Entity.Methods, instance.Types.Entity, instance.Types.Entity.Wrap, instance.Types.Entity.Unwrap
	...
	if CLIENT then
		...
		function ents_methods:setMesh(mesh)
			...
			if not ent_tbl.IsSFHologram and not ent_tbl.IsSFProp then
				SF.Throw("The entity isn't a hologram or custom-prop", 2)
			end
		...
		function ents_methods:setSheetColor(clr)
			...
			elseif playerColorWhitelist[Ent_GetClass(ent)] then
				Ent_GetTable(ent).GetPlayerColor = function()
					return vec
				end
			else
		...
		function ents_methods:draw()
			if not instance.data.render.isRendering then
				SF.Throw("Not in rendering hook.", 2)
			end

			local ent = getent(self)
			if not canDrawEntity(ent) then
				SF.Throw("Can't draw this entity.", 2)
			end
			Ent_SetupBones(ent)
			Ent_DrawModel(ent)
		end
	...
	function ents_methods:getLinkedComponents()
		...
		if Ent_GetClass(ent) == "starfall_processor" then
			for k, v in ipairs(ents.FindByClass("starfall_screen")) do
				if Ent_GetTable(v).link == ent then
					list[#list + 1] = ewrap(v)
				end
			end
		...
		elseif Ent_GetClass(ent) == "starfall_hud" then
			if SERVER then
				for k, huds in pairs(SF.HudVehicleLinks) do
					if huds[ent] then
						list[#list + 1] = owrap(k)
					end
				end
	...
	function ents_methods:setParent(parent, attachment, bone)
		...
		if CLIENT and dgetmeta(child) ~= SF.Cl_Hologram_Meta then
			SF.Throw("Only clientside holograms can be parented in the CLIENT realm!", 2)
		end
		if attachment ~= nil and bone ~= nil then
			SF.Throw("Arguments `attachment` and `bone` are mutually exclusive!", 2)
		end
		if parent ~= nil then
			parent = getent(parent)
			if Ent_IsPlayer(parent) and not Ent_GetTable(child).IsSFHologram then
				SF.Throw("Only holograms can be parented to players!", 2)
			end
			local param, type
			if bone ~= nil then
				...
				if bone < 0 or bone > 255 then
					SF.Throw("Invalid bone provided!", 2)
				end
				type = "bone"
				param = bone
			elseif attachment ~= nil then
				if CLIENT then
					SF.Throw("Parenting to an attachment is not supported in clientside!", 2)
				end
				if isstring(attachment) then
					attachment = { attachment, Ent_LookupAttachment(parent, attachment) }
					if attachment[2] < 1 then
						SF.Throw("Invalid attachment provided!", 2)
					end
				elseif isnumber(attachment) then
					local attachments = Ent_GetAttachments(parent)
					local name = attachments and attachments[attachment] and attachments[attachment].name
						or SF.Throw("Invalid attachment ID provided!", 2)
	...
	function ents_methods:manipulateBonePosition(bone, vec)
		...
		if bone < 0 or bone >= Ent_GetBoneCount(ent) then
			SF.Throw("Invalid bone " .. bone, 2)
		end
	...
	function ents_methods:setColor(clr)
		...
		local r, g, b, a =
			tonumber(clr.r) or 255, tonumber(clr.g) or 255, tonumber(clr.b) or 255, tonumber(clr.a) or 255
		...
		if SERVER then
			duplicator.StoreEntityModifier(
				ent,
				"colour",
				{ Color = { r = r, g = g, b = b, a = a }, RenderMode = rendermode }
			)
		end
	end
	...
	function ents_methods:setMaterial(material)
		...
		if SF.CheckMaterial(material) == false then
			SF.Throw("This material is invalid", 2)
		end
	...
	function ents_methods:getPhysicsObject()
		...
		if Ent_IsWorld(ent) then
			SF.Throw("Cannot get the world physobj.", 2)
		end
	...
	function ents_methods:getChipAuthor()
		...
		if not ent_tbl.Starfall then
			SF.Throw("The entity isn't a neostarfall chip", 2)
		end
	...
	function ents_methods:getMassCenter()
		...
		if not Phys_IsValid(phys) then
			SF.Throw("Physics object is invalid", 2)
		end
	...
	function ents_methods:getSequenceInfo(id)
		local ent = getent(self)
		checkluatype(id, TYPE_NUMBER)
		if id < 0 or id > Ent_GetSequenceCount(ent) - 1 then
			SF.Throw("Sequence ID out of bounds", 2)
		end
	...
	function ents_methods:getSubMaterial(index)
		...
		if index < 0 or index > 31 then
			SF.Throw("Index must be an int in range 0 - 31")
		end
	...
	function ents_methods:getDTAngle(key)
		...
		if key < 0 or key > 31 then
			SF.Throw("Key must be a int in range 0 - 31")
		end
